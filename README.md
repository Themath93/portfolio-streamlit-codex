...
- **포르투갈어 스타일 홈 히어로**: 첨부 예시와 동일한 히어로 카드·연락처 카드·"Formação & Experiência"·"Habilidades Técnicas" 섹션을 Streamlit CSS로 재현
...
- 홈 화면은 히어로 카드, 연락처 카드, 기술 스택 카드 등 맞춤 CSS 클래스로 구성되어 있어 첨부된 포르투갈어 포트폴리오 레이아웃과 동일한 느낌을 유지합니다.
